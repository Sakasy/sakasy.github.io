...
<iframe src="https://chart-studio.plotly.com/~iradukun/185.embed" width="800" height="500" frameborder="0" scrolling="no"></ifram
...
##### NLP graphs 
{% include figure.html image="low_cloud.png"  position="right" width="600" height="800" %}
{% include figure.html image="need_cloud.png" position="left" width="600" height="800" %}
{% include figure.html image="lack_cloud.png"  position="right" width="700" height="800" %}
{% include figure.html image="great_cloud.png"  position="left" width="600" height="800" %}
{% include figure.html image="knowledge_cloud.png"  position="right" width="600" height="800" %}
